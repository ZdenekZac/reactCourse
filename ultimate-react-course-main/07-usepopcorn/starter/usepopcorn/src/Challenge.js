...
export default function App() {
  return (
    <div>
      <TextExpander expandButtonText="Show More" collapseButtonText="hide text" buttonColor="blue" className="box">
...
function TextExpander({
  ...
  const displayText = isExp ? children : children.split(" ", collapsedNumWords).join(" ");
