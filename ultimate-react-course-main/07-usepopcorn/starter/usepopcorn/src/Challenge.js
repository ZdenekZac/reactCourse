...
function TextExpander({ children, collapsedNumWords, bgColor, expanded, expandButtonText, collapseButtonText, buttonColor}){
	const [exp, setExp] = useState(false)
  	const textExpStyles = {
	backgroundColor:`${bgColor}`,
  }
  return (<><p style={textExpStyles}>{exp ? 
  				children : children.split(" ", collapsedNumWords).join(" ")}</p>
			<Button 
